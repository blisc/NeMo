...
from ...utils.nlp_utils import get_vocab, write_vocab, write_vocab_in_order, label2idx
...
def download_wkt2(data_dir):
    ...
    nemo.logging.warning(f'Data not found at {data_dir}. ' f'Download {dataset_name} to data/lm')
