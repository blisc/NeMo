...
class PtActions(Actions):
    def __init__(
        self, local_rank=None, global_rank=None, tb_writer=None, optimization_level=Optimization.mxprO0, logger=None
    ):
    ...
    @staticmethod
    def __module_export(
        module, output, d_format: DeploymentFormat, input_example=None, output_example=None, logger=None
    ):
        ...
        try:
            ...
            if logger:
                logger.error(f'ERROR: module export failed for {module} with ' f'exception {e}')
            else:
                print(f'ERROR: module export failed for {module} with ' f'exception {e}')
        finally:
    ...
    def deployment_export(
        module, output: str, d_format: DeploymentFormat, input_example=None, output_example=None, logger=None
    ):
