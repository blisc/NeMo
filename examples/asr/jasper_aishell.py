...
def create_all_dags(args, neural_factory):
    ...
    train_callback = nemo.core.SimpleLossLoggerCallback(
        ...
        print_func=partial(monitor_asr_train_progress, labels=vocab, eval_metric='CER', logger=logger),
    ...
    for i, eval_dl in enumerate(data_layers_eval):
        ...
        eval_callback = nemo.core.EvaluatorCallback(
            ...
            user_epochs_done_callback=partial(process_evaluation_epoch, eval_metric='CER', tag=tagname, logger=logger),
