...
import nemo
import nemo_asr
from nemo_asr.helpers import word_error_rate, post_process_predictions, post_process_transcripts
...
def main():
    ...
    if args.lm_path:
        ...
        logger.info('Best (alpha, beta): ' f'{best_beam_wer[0]}, ' f'WER: {best_beam_wer[1]:.2f}%')
