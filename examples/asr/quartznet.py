...
def create_all_dags(args, neural_factory):
    ...
    train_callback = nemo.core.SimpleLossLoggerCallback(
        ...
        print_func=partial(monitor_asr_train_progress, labels=vocab, logger=neural_factory.logger),
    ...
    for i, eval_dl in enumerate(data_layers_eval):
        ...
        eval_callback = nemo.core.EvaluatorCallback(
            ...
            user_epochs_done_callback=partial(process_evaluation_epoch, tag=tagname, logger=neural_factory.logger),
