...
import nemo_nlp
from nemo_nlp.utils.callbacks.translation import eval_iter_callback, eval_epochs_done_callback
...
if args.src_lang == 'en' and args.tgt_lang == 'de':
    ...
    nf.logger.info(f"Unsupported language pair:{args.src_lang}-{args.tgt_lang}.")
    exit(1)
