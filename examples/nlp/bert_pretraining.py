...
from nemo_nlp.utils.callbacks.bert_pretraining import eval_iter_callback, eval_epochs_done_callback
...
train_callback = nemo.core.SimpleLossLoggerCallback(
    ...
    print_func=lambda x: nf.logger.info(print_msg.format(*[y.item() for y in x])),
